...
func template_button(url_text string, site_text string, imageURL string, title_text string, info_text string, no_template_msg string) string {
...
// 				log.Print("userID := event.Source.UserID = " + userID)
				...
				if bot_msg != ""{
					if bot_msg == "GOTEST"{
						...
						template_button("http://ani.gamer.com.tw/animeVideo.php?sn=6878", "第？話", "https://p2.bahamut.com.tw/B/2KU/33/0001485933.PNG", "查詢結果", "動畫名稱 ", bot_msg ) 
