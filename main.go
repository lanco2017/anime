...
// 						}
						...
						obj_message := [5] *linebot.StickerMessag{linebot.NewStickerMessage("1", "1"),linebot.NewStickerMessage("1", "1"),linebot.NewStickerMessage("1", "1"),linebot.NewStickerMessage("1", "1"),linebot.NewStickerMessage("1", "1")}
