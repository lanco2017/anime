...
`
	...
	case "動畫", "動畫瘋","巴哈","巴哈姆特", "anime", "アニメ","Anime","ａｎｉｍｅ","Ａｎｉｍｅ","懶":
		...
		case "戀愛暴君":
			...
			case "3","03":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7643"
			default:
			}
		//2017.04
		case "武裝少女 Machiavellianism","Machiavellianism","武裝少女":
			...
			case "3","03":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7637"
			default:
			}
		//2017.04
		case "重啟咲良田","重啟":
			...
			case "3","03":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7641"
			default:
			}
		//2017.04
		case "王室教師海涅","海涅","王室教師":
		...
		case "攻殼機動隊 ARISE","ARISE","攻殼機動隊":
			...
			switch reg.ReplaceAllString(text, "$5") {
			case "1","01":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7563"
			case "2","02":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7564"
			case "3","03":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7565"
			case "4","04":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7566"
			default:
			}
		case "ｓａｏ","ＳＡＯ","sao","SAO","Sword Art Online","Sword Art Online 刀劍神域","刀劍神域","刀劍":
			//reg.ReplaceAllString(text, "$2")
			switch reg.ReplaceAllString(text, "$5") {
			case "1","01":
		...
		case "BanG Dream","Bang","BanG","bang":
			switch reg.ReplaceAllString(text, "$5") {
			case "1","01":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7147"
			case "2","02":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7321"
			case "3","03":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7322"
			case "4","04":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7395"
			case "5","05":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7396"
			case "6","06":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7397"
			case "7","07":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7398"
			case "8","08":
		...
		case "為美好的世界獻上祝福！ 第二季","為美好的世界獻上祝福","獻上祝福！ 第二季","美好的世界":
		   //reg.ReplaceAllString(text, "$2")
			switch reg.ReplaceAllString(text, "$5") {
				...
				case "10":
					print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7460"
			default:
			}
		case "夏雪之約","夏雪":
		   //reg.ReplaceAllString(text, "$2")
		...
		case "南鎌倉高校女子自行車社","南鎌倉自行車","南鎌倉高校","女子自行車":
		   //reg.ReplaceAllString(text, "$2")
			...
			case "12":
					print_string = anime_say + "http://ani.gamer.com.tw/animeVideo.php?sn=7483"
			default:
					print_string = anime_say + "http://ani.gamer.com.tw/animeVideo.php?sn=7127"
			}
		case "花舞少女","花舞":
		...
		case "亞人醬有話要說","亞人","亞人醬","有話","有話要說":
		   //reg.ReplaceAllString(text, "$2")
			...
			case "12":
					print_string = anime_say + "http://ani.gamer.com.tw/animeVideo.php?sn=7496"
			default:
			}
		//2017.01
		...
		case "殺老師","殺老師 Q","殺老師Q","殺老師 Q！":
			...
			case "12":
				print_string = anime_say + "http://ani.gamer.com.tw/animeVideo.php?sn=7450"
			default:
			}
		case "路人超能 100","路人","靈能":
			//reg.ReplaceAllString(text, "$2")
		...
		case "喵阿愣！","喵阿愣","喵啊愣！","阿愣","啊愣","喵阿楞！","喵阿楞":
			...
			case "26":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7479"
			default:
			}
		case "雙星之陰陽師","雙星":
			//reg.ReplaceAllString(text, "$2")
		...
		case "3月","3 月的獅子","3月的獅子","三月的獅子","三月":
			...
			case "20":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7402"
			case "21":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7492"
			case "22":
				print_string = anime_say + "https://ani.gamer.com.tw/animeVideo.php?sn=7493"
			default:
				print_string = anime_say + "http://ani.gamer.com.tw/animeVideo.php?sn=6479"
			}
	...
	for _, event := range events {
		...
		LineTemplate_firstinfo := linebot.NewCarouselTemplate(
			...
			LineTemplate_feedback,
							...
							fb_msg := "\n\n答案請上 FB 查詢大家意見。\n" + "巴哈姆特動畫瘋 FB：\nhttps://www.facebook.com/animategamer/posts/1396068670455500"
							fb_q_msg := "2017/04/26 動漫通\n" +
"關聯：RWBY\n" +
"問題：請問 寒冰之花（Ice Flower）是哪兩位的組合魔法\n" +
"1.Ruby＆Weiss\n" +
"2.Weiss＆Blake\n" +
"3.Blake＆Yang\n" +
"4.Yang＆Ruby\n" +
...
"出題者：darren325836\n" +
							...
							LineTemplate_today_q := linebot.NewCarouselTemplate(
								linebot.NewCarouselColumn(
									imageURL, "2017/04/26 動漫通", "答案請參考 FB 討論，可能是 1 ",
									linebot.NewURITemplateAction("來看 FB 上的答案！","https://www.facebook.com/animategamer/posts/1396068670455500"),
