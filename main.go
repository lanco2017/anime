...
// 						}
						...
						obj_message := [5] Message{linebot.NewStickerMessage("1", "1"),linebot.NewStickerMessage("1", "1"),linebot.NewStickerMessage("1", "1"),linebot.NewStickerMessage("1", "1"),linebot.NewStickerMessage("1", "1")}
